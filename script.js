...
const IMG = (id, w=600, h=400) => `https://images.unsplash.com/photo-${id}?w=${w}&h=${h}&fit=crop&q=80`;

const PLACEHOLDER_GEMS = [
  { id:'p1',  price:0, _placeholder:true, diamond:{ image:IMG('1515562141207-7a88fb7ce338'), video:null, certificate:{ lab:'GIA',  certNumber:'7418523690', shape:'Round Brilliant',  carats:'3.42', clarity:'IF',   cut:'Excellent',  polish:'Excellent',  symmetry:'Excellent',  color:'D',                    f_color:'',                     floInt:'None',  pdfUrl:null } } },
  { id:'p2',  price:0, _placeholder:true, diamond:{ image:IMG('1573408301185-9519f69bc5a0'), video:null, certificate:{ lab:'GIA',  certNumber:'2467891234', shape:'Oval',             carats:'2.18', clarity:'VVS1', cut:'Excellent',  polish:'Excellent',  symmetry:'Very Good',  color:'E',                    f_color:'',                     floInt:'Faint', pdfUrl:null } } },
  { id:'p3',  price:0, _placeholder:true, diamond:{ image:IMG('1605100804763-247f67b3557e'), video:null, certificate:{ lab:'IGI',  certNumber:'591234567',  shape:'Emerald',          carats:'4.05', clarity:'VS1',  cut:'Excellent',  polish:'Excellent',  symmetry:'Excellent',  color:'F',                    f_color:'',                     floInt:'None',  pdfUrl:null } } },
  { id:'p4',  price:0, _placeholder:true, diamond:{ image:IMG('1515562141207-7a88fb7ce338',600,400), video:null, certificate:{ lab:'GIA',  certNumber:'6301982345', shape:'Cushion',    carats:'5.60', clarity:'VS2',  cut:'Very Good', polish:'Excellent',  symmetry:'Very Good',  color:'G',                    f_color:'',                     floInt:'None',  pdfUrl:null } } },
  { id:'p5',  price:0, _placeholder:true, diamond:{ image:IMG('1573408301185-9519f69bc5a0',600,400), video:null, certificate:{ lab:'GIA',  certNumber:'2159834560', shape:'Pear',       carats:'1.87', clarity:'VVS2', cut:'Excellent',  polish:'Excellent',  symmetry:'Excellent',  color:'D',                    f_color:'',                     floInt:'None',  pdfUrl:null } } },
  { id:'p6',  price:0, _placeholder:true, diamond:{ image:IMG('1617038220319-276d3cfab638'), video:null, certificate:{ lab:'HRD',  certNumber:'230456789',  shape:'Princess',         carats:'2.30', clarity:'SI1',  cut:'Very Good', polish:'Very Good',   symmetry:'Very Good',  color:'H',                    f_color:'',                     floInt:'None',  pdfUrl:null } } },
  { id:'p7',  price:0, _placeholder:true, diamond:{ image:IMG('1599707367072-cd6ada2bc375'), video:null, certificate:{ lab:'GIA',  certNumber:'7814523610', shape:'Radiant',          carats:'7.14', clarity:'VS1',  cut:'Excellent',  polish:'Excellent',  symmetry:'Excellent',  color:'Fancy Intense Yellow',  f_color:'Fancy Intense Yellow', floInt:'None',  pdfUrl:null } } },
  { id:'p8',  price:0, _placeholder:true, diamond:{ image:IMG('1605100804763-247f67b3557e',600,400), video:null, certificate:{ lab:'GIA',  certNumber:'5291047382', shape:'Marquise',  carats:'2.94', clarity:'VVS1', cut:'Excellent',  polish:'Excellent',  symmetry:'Excellent',  color:'E',                    f_color:'',                     floInt:'None',  pdfUrl:null } } },
  { id:'p9',  price:0, _placeholder:true, diamond:{ image:IMG('1515562141207-7a88fb7ce338',600,401), video:null, certificate:{ lab:'GIA',  certNumber:'1023847561', shape:'Heart',     carats:'3.10', clarity:'VS2',  cut:'Very Good', polish:'Excellent',  symmetry:'Very Good',  color:'F',                    f_color:'',                     floInt:'Faint', pdfUrl:null } } },
  { id:'p10', price:0, _placeholder:true, diamond:{ image:IMG('1573408301185-9519f69bc5a0',600,401), video:null, certificate:{ lab:'GIA',  certNumber:'3849201756', shape:'Asscher',   carats:'3.75', clarity:'VVS2', cut:'Excellent',  polish:'Excellent',  symmetry:'Excellent',  color:'D',                    f_color:'',                     floInt:'None',  pdfUrl:null } } },
  { id:'p11', price:0, _placeholder:true, diamond:{ image:IMG('1617038220319-276d3cfab638',600,401), video:null, certificate:{ lab:'GIA',  certNumber:'4712039845', shape:'Round Brilliant',  carats:'1.52', clarity:'IF',   cut:'Excellent',  polish:'Excellent',  symmetry:'Excellent',  color:'E',       f_color:'',                     floInt:'None',  pdfUrl:null } } },
  { id:'p12', price:0, _placeholder:true, diamond:{ image:IMG('1605100804763-247f67b3557e',600,401), video:null, certificate:{ lab:'IGI',  certNumber:'674892013',  shape:'Oval',             carats:'4.88', clarity:'VS1',  cut:'Excellent',  polish:'Excellent',  symmetry:'Excellent',  color:'G',       f_color:'',                     floInt:'None',  pdfUrl:null } } },
  { id:'p13', price:0, _placeholder:true, diamond:{ image:IMG('1599707367072-cd6ada2bc375',600,401), video:null, certificate:{ lab:'GIA',  certNumber:'9023156478', shape:'Cushion',          carats:'6.20', clarity:'VS2',  cut:'Very Good', polish:'Very Good',   symmetry:'Very Good',  color:'Fancy Vivid Blue',  f_color:'Fancy Vivid Blue',  floInt:'None',  pdfUrl:null } } },
  { id:'p14', price:0, _placeholder:true, diamond:{ image:IMG('1515562141207-7a88fb7ce338',600,402), video:null, certificate:{ lab:'HRD',  certNumber:'812045679',  shape:'Emerald',          carats:'2.67', clarity:'VVS1', cut:'Excellent',  polish:'Excellent',  symmetry:'Excellent',  color:'F',       f_color:'',                     floInt:'None',  pdfUrl:null } } },
  { id:'p15', price:0, _placeholder:true, diamond:{ image:IMG('1617038220319-276d3cfab638',600,402), video:null, certificate:{ lab:'GIA',  certNumber:'6038417290', shape:'Pear',             carats:'3.31', clarity:'VVS2', cut:'Excellent',  polish:'Excellent',  symmetry:'Very Good',  color:'D',       f_color:'',                     floInt:'None',  pdfUrl:null } } },
  { id:'p16', price:0, _placeholder:true, diamond:{ image:IMG('1573408301185-9519f69bc5a0',600,402), video:null, certificate:{ lab:'GIA',  certNumber:'5190283746', shape:'Princess',         carats:'1.98', clarity:'SI1',  cut:'Very Good', polish:'Excellent',  symmetry:'Very Good',  color:'H',       f_color:'',                     floInt:'Faint', pdfUrl:null } } },
];
